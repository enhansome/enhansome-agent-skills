...
* **[serpapi/serpapi-search-tools-python](https://github.com/serpapi/serpapi-search-tools-python) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2026-09-25** - Real-time search tools for Python agents with native support for popular agent SDKs
...
* **[testmu-ai/api-skill](https://github.com/LambdaTest/agent-skills/tree/main/api-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Suite of API skills for designing, mocking, documenting, securing, and generating tests for REST/GraphQL/gRPC APIs
* **[testmu-ai/appium-skill](https://github.com/LambdaTest/agent-skills/tree/main/appium-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Appium mobile automation for Android and iOS in Java, Python, or JS
* **[testmu-ai/behat-skill](https://github.com/LambdaTest/agent-skills/tree/main/behat-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Behat BDD tests for PHP with Gherkin and Mink
* **[testmu-ai/behave-skill](https://github.com/LambdaTest/agent-skills/tree/main/behave-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Behave BDD tests for Python with Gherkin and step implementations
* **[testmu-ai/capybara-skill](https://github.com/LambdaTest/agent-skills/tree/main/capybara-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Capybara E2E tests in Ruby with RSpec integration
* **[testmu-ai/cicd-pipeline-skill](https://github.com/LambdaTest/agent-skills/tree/main/cicd-pipeline-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate CI/CD pipelines for tests on GitHub Actions, Jenkins, GitLab CI, and Azure DevOps
* **[testmu-ai/codeception-skill](https://github.com/LambdaTest/agent-skills/tree/main/codeception-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Codeception acceptance, functional, and unit tests in PHP
* **[testmu-ai/cucumber-skill](https://github.com/LambdaTest/agent-skills/tree/main/cucumber-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Cucumber BDD tests with Gherkin and step definitions in Java, JS, or Ruby
* **[testmu-ai/cypress-skill](https://github.com/LambdaTest/agent-skills/tree/main/cypress-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Cypress E2E and component tests in JavaScript or TypeScript
* **[testmu-ai/detox-skill](https://github.com/LambdaTest/agent-skills/tree/main/detox-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Detox gray-box E2E tests for React Native apps in JavaScript
* **[testmu-ai/espresso-skill](https://github.com/LambdaTest/agent-skills/tree/main/espresso-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Espresso UI tests for Android apps in Kotlin or Java
* **[testmu-ai/flutter-testing-skill](https://github.com/LambdaTest/agent-skills/tree/main/flutter-testing-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Flutter widget, integration, and golden tests in Dart
* **[testmu-ai/gauge-skill](https://github.com/LambdaTest/agent-skills/tree/main/gauge-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Gauge specs in Markdown with steps in Java, Python, JS, or Ruby
* **[testmu-ai/geb-skill](https://github.com/LambdaTest/agent-skills/tree/main/geb-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Geb browser automation in Groovy with Spock and page objects
* **[testmu-ai/hyperexecute-skill](https://github.com/LambdaTest/agent-skills/tree/main/hyperexecute-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Operate TestMu AI HyperExecute end-to-end: YAML, CLI runs, debugging, and CI wiring
* **[testmu-ai/jasmine-skill](https://github.com/LambdaTest/agent-skills/tree/main/jasmine-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Jasmine BDD tests in JavaScript with spies and async support
* **[testmu-ai/jest-skill](https://github.com/LambdaTest/agent-skills/tree/main/jest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Jest unit and integration tests in JS/TS with mocking and snapshots
* **[testmu-ai/junit-5-skill](https://github.com/LambdaTest/agent-skills/tree/main/junit-5-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate JUnit 5 unit and integration tests in Java with Mockito
* **[testmu-ai/karma-skill](https://github.com/LambdaTest/agent-skills/tree/main/karma-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Karma test-runner configs for browser-based JS testing
* **[testmu-ai/laravel-dusk-skill](https://github.com/LambdaTest/agent-skills/tree/main/laravel-dusk-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Laravel Dusk Chrome-based browser tests in PHP
* **[testmu-ai/lettuce-skill](https://github.com/LambdaTest/agent-skills/tree/main/lettuce-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Lettuce BDD tests for Python (legacy; prefer Behave)
* **[testmu-ai/mocha-skill](https://github.com/LambdaTest/agent-skills/tree/main/mocha-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Mocha tests in JavaScript with Chai and Sinon
* **[testmu-ai/mstest-skill](https://github.com/LambdaTest/agent-skills/tree/main/mstest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate MSTest tests in C# for .NET
* **[testmu-ai/nemojs-skill](https://github.com/LambdaTest/agent-skills/tree/main/nemojs-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Nemo.js Selenium-based tests for Node.js
* **[testmu-ai/nightwatchjs-skill](https://github.com/LambdaTest/agent-skills/tree/main/nightwatchjs-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate NightwatchJS E2E tests in JavaScript with Selenium WebDriver
* **[testmu-ai/nunit-skill](https://github.com/LambdaTest/agent-skills/tree/main/nunit-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate NUnit 3 tests in C# with the constraint model and Moq
* **[testmu-ai/phpunit-skill](https://github.com/LambdaTest/agent-skills/tree/main/phpunit-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate PHPUnit tests in PHP with data providers and mocking
* **[testmu-ai/playwright-skill](https://github.com/LambdaTest/agent-skills/tree/main/playwright-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Playwright E2E tests in TS, JS, Python, Java, or C#
* **[testmu-ai/protractor-skill](https://github.com/LambdaTest/agent-skills/tree/main/protractor-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Protractor E2E tests for Angular in JS/TS (deprecated; prefer Playwright/Cypress)
* **[testmu-ai/puppeteer-skill](https://github.com/LambdaTest/agent-skills/tree/main/puppeteer-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Puppeteer scripts for browser automation, scraping, and PDF generation
* **[testmu-ai/pytest-skill](https://github.com/LambdaTest/agent-skills/tree/main/pytest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate pytest tests in Python with fixtures, parametrize, and mocking
* **[testmu-ai/reqnroll-skill](https://github.com/LambdaTest/agent-skills/tree/main/reqnroll-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Reqnroll BDD tests for web and mobile in C#
* **[testmu-ai/robot-framework-skill](https://github.com/LambdaTest/agent-skills/tree/main/robot-framework-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Robot Framework keyword-driven tests in Python
* **[testmu-ai/rspec-skill](https://github.com/LambdaTest/agent-skills/tree/main/rspec-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate RSpec tests in Ruby with matchers, hooks, and mocking
* **[testmu-ai/selenide-skill](https://github.com/LambdaTest/agent-skills/tree/main/selenide-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Selenide UI tests in Java with auto-waits and a fluent API
* **[testmu-ai/selenium-skill](https://github.com/LambdaTest/agent-skills/tree/main/selenium-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Selenium WebDriver tests in Java, Python, JS, C#, Ruby, or PHP
* **[testmu-ai/serenity-bdd-skill](https://github.com/LambdaTest/agent-skills/tree/main/serenity-bdd-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Serenity BDD tests in Java with the Screenplay pattern and reporting
* **[testmu-ai/smartui-skill](https://github.com/LambdaTest/agent-skills/tree/main/smartui-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate SmartUI visual regression configs for screenshot comparison
* **[testmu-ai/specflow-skill](https://github.com/LambdaTest/agent-skills/tree/main/specflow-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate SpecFlow BDD tests for C#/.NET with Gherkin and step bindings
* **[testmu-ai/test-framework-migration-skill](https://github.com/LambdaTest/agent-skills/tree/main/test-framework-migration-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Migrate tests between Selenium, Playwright, Puppeteer, and Cypress
* **[testmu-ai/testcafe-skill](https://github.com/LambdaTest/agent-skills/tree/main/testcafe-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate TestCafe automation tests in JavaScript or TypeScript
* **[testmu-ai/testng-skill](https://github.com/LambdaTest/agent-skills/tree/main/testng-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate TestNG tests in Java with data providers and parallel execution
* **[testmu-ai/testunit-skill](https://github.com/LambdaTest/agent-skills/tree/main/testunit-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Test::Unit xUnit-style tests in Ruby
* **[testmu-ai/unittest-skill](https://github.com/LambdaTest/agent-skills/tree/main/unittest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Python unittest tests with TestCase and setUp/tearDown
* **[testmu-ai/vitest-skill](https://github.com/LambdaTest/agent-skills/tree/main/vitest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate Vitest tests in JS/TS with a Jest-compatible API and ESM
* **[testmu-ai/webdriverio-skill](https://github.com/LambdaTest/agent-skills/tree/main/webdriverio-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate WebdriverIO (WDIO) automation tests in JavaScript or TypeScript
* **[testmu-ai/xcuitest-skill](https://github.com/LambdaTest/agent-skills/tree/main/xcuitest-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate XCUITest UI tests for iOS/iPadOS apps in Swift
* **[testmu-ai/xunit-skill](https://github.com/LambdaTest/agent-skills/tree/main/xunit-skill) ⭐ 371 | 🐛 3 | 🌐 Python | 📅 2026-09-25** - Generate xUnit.net tests in C# with Fact/Theory and FluentAssertions
...
* **[veniceai/venice-api-overview](https://github.com/veniceai/skills/tree/main/skills/venice-api-overview) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - API basics, auth modes, pricing, and versioning
* **[veniceai/venice-auth](https://github.com/veniceai/skills/tree/main/skills/venice-auth) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - API keys and wallet-based Venice authentication
* **[veniceai/venice-chat](https://github.com/veniceai/skills/tree/main/skills/venice-chat) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Chat completions, multimodal inputs, tools, and streaming
* **[veniceai/venice-responses](https://github.com/veniceai/skills/tree/main/skills/venice-responses) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - OpenAI-compatible Responses API for Venice
* **[veniceai/venice-embeddings](https://github.com/veniceai/skills/tree/main/skills/venice-embeddings) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Embeddings models, dimensions, and encoding formats
* **[veniceai/venice-image-generate](https://github.com/veniceai/skills/tree/main/skills/venice-image-generate) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Image generation endpoints and available styles
* **[veniceai/venice-image-edit](https://github.com/veniceai/skills/tree/main/skills/venice-image-edit) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Image edits, upscaling, and background removal
* **[veniceai/venice-audio-speech](https://github.com/veniceai/skills/tree/main/skills/venice-audio-speech) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Text-to-speech models, voices, formats, and streaming
* **[veniceai/venice-audio-music](https://github.com/veniceai/skills/tree/main/skills/venice-audio-music) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Music generation queueing, retrieval, and completion endpoints
* **[veniceai/venice-audio-transcription](https://github.com/veniceai/skills/tree/main/skills/venice-audio-transcription) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Audio transcription models and speech-to-text options
* **[veniceai/venice-video](https://github.com/veniceai/skills/tree/main/skills/venice-video) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Video generation and transcription workflows
* **[veniceai/venice-models](https://github.com/veniceai/skills/tree/main/skills/venice-models) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Model catalog, traits, and compatibility mappings
* **[veniceai/venice-characters](https://github.com/veniceai/skills/tree/main/skills/venice-characters) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Character endpoints and `character_slug` usage
* **[veniceai/venice-api-keys](https://github.com/veniceai/skills/tree/main/skills/venice-api-keys) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - API key CRUD, rate limits, and Web3 keys
* **[veniceai/venice-billing](https://github.com/veniceai/skills/tree/main/skills/venice-billing) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Balance, usage, and billing analytics endpoints
* **[veniceai/venice-x402](https://github.com/veniceai/skills/tree/main/skills/venice-x402) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Wallet credits and x402 payments on Base
* **[veniceai/venice-crypto-rpc](https://github.com/veniceai/skills/tree/main/skills/venice-crypto-rpc) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - JSON-RPC proxying for supported crypto networks
* **[veniceai/venice-augment](https://github.com/veniceai/skills/tree/main/skills/venice-augment) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Search, scraping, and text parsing endpoints
* **[veniceai/venice-errors](https://github.com/veniceai/skills/tree/main/skills/venice-errors) ⭐ 144 | 🐛 14 | 🌐 Python | 📅 2026-09-21** - Error handling, retries, and API status codes
...
* **[realkimbarrett/avatar-extraction](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/foundations/avatar-extraction) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Define exactly who the buyer is, what they want, what they've tried, and what's driving their decisions
* **[realkimbarrett/offer-extraction](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/foundations/offer-extraction) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Turn a product or service into a compelling, high-converting offer
* **[realkimbarrett/schwartz-awareness-mapper](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/copy-chief/schwartz-awareness-mapper) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Determine audience awareness level and the correct messaging approach
* **[realkimbarrett/mechanism-builder](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/copy-chief/mechanism-builder) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Explain why your solution works and others failed with a unique mechanism
* **[realkimbarrett/headline-matrix](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/copy-chief/headline-matrix) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Generate high-performing headline variations across different angles
* **[realkimbarrett/objection-crusher](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/copy-chief/objection-crusher) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Identify and neutralize buyer objections and hesitation
* **[realkimbarrett/ad-angle-multiplier](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/operator-os/ad-angle-multiplier) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Expand a core idea into multiple distinct ad angles for creative testing
* **[realkimbarrett/scroll-stopping-creative](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/operator-os/scroll-stopping-creative) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Create ad concepts that stop attention in the first 3 seconds
* **[realkimbarrett/conversion-path-builder](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/operator-os/conversion-path-builder) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Design the optimal funnel from click to conversion and booked calls
* **[realkimbarrett/performance-diagnosis](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/operator-os/performance-diagnosis) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Diagnose why campaigns are underperforming — low conversion, high CPL, bad ads
* **[realkimbarrett/full-funnel-campaign-orchestrator](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/orchestrators/full-funnel-campaign-orchestrator) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Coordinate all skills to build a complete ads + funnel campaign end-to-end
* **[realkimbarrett/generic-language-killer](https://github.com/realkimbarrett/advertising-skills/tree/main/skills/qa/generic-language-killer) ⭐ 755 | 🐛 2 | 📅 2026-03-26** - Remove vague, corporate, or AI-sounding language and replace it with clear, specific, human wording
...
* **[YannisKiefer/dark-psychology-skills](https://github.com/YannisKiefer/dark-psychology-skills) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-08-25** - 13 sales and negotiation skills for agents distilled from 36 books (CIA psyop manuals, FBI behavioral research, propaganda science, persuasion classics); every tactic passes an honest-influence filter: it must still work when fully disclosed
...
* **[Digidai/product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 179 | 🐛 0 | 🌐 Shell | 📅 2026-04-12** - Senior PM agent with 30+ frameworks and SaaS metrics
* **[gokapso/integrate-whatsapp](https://github.com/gokapso/agent-skills/tree/master/skills/integrate-whatsapp) ⭐ 166 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-24** - Connect WhatsApp, set up webhooks, and send messages
* **[gokapso/automate-whatsapp](https://github.com/gokapso/agent-skills/tree/master/skills/automate-whatsapp) ⭐ 166 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-24** - Build WhatsApp automations with workflows and agents
...
* **[hedralab/eskill](https://github.com/hedralab/eskill) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-25** - Meta-skill to build top-tier Agent Skills: spec-compliant SKILL.md, eval loop, validator, market research, numbered-file pipeline
